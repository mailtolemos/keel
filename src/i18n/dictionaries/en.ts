const en: Record<string, string> = {
  ...
  "set.roleEmployeeDesc": "Manage their own profile, requests, goals, feedback, and reviews.",
  "set.paid": "Paid",
  "set.unpaid": "Unpaid",
  "set.daysYr": "days / yr",
  "set.holidayCal": "Holiday calendar",
  "set.holidayName": "Holiday name",
  "set.date": "Date",
  "set.noHolidays": "No holidays yet.",
  "set.reviewsTitle": "Review templates",
  "set.reviewsBody": "Question sets and rating scales are configured when you create a review cycle. Saved templates are coming soon.",
  "set.feedbackTitle": "Feedback settings",
  "set.feedbackBody": "Feedback is continuous and lightweight. Visibility can be public, manager-only, or private on each note.",
  "set.goalsTitle": "Goal settings",
  "set.goalsBody": "Goals can be set at the company, team, or individual level, each with progress tracking and updates.",
  "set.billingTitle": "Billing",
  "set.billingBody": "You're on the Keel demo plan. Billing and plan management will appear here.",
  "set.integrationsTitle": "Integrations",
  "set.integrationsBody": "Connect Slack, Google Workspace, and your HRIS. Integrations are placeholders in this preview.",
  "set.demoPlan": "Demo plan",
  "vis.PUBLIC": "Public",
  "vis.MANAGER_ONLY": "Manager-only",
  "vis.PRIVATE": "Private",
  "people.colName": "Name",
  "people.colTeam": "Team",
  "people.colManager": "Manager",
  "people.colLocation": "Location",
  "people.colRole": "Role",
  "people.colStatus": "Status",
  "people.allTeams": "All teams",
  "people.allStatuses": "All statuses",
  "people.noMatch": "No people match your filters.",
  ...
  "auth.resetSentMsg": "If an account exists for that email, a reset link is on its way.",
  "auth.devLinkNote": "Email isn't configured yet — use this link:",
  ...
  "auth.passwordUpdatedMsg": "Your password has been changed. You can now sign in.",
  "auth.resetInvalid": "This reset link is invalid or has expired.",
  "auth.goToSignIn": "Go to sign in",
  "auth.backToSignIn": "← Back to sign in",
  "join.title": "Join {company}",
  "join.sub": "Set your password to get started.",
  "join.invalidTitle": "Invitation not found",
  "join.invalidMsg": "This invitation is invalid or has already been used. Ask your admin to resend it.",
  ...
  "people.sendInvite": "Send invite",
  "people.adding": "Sending…",
  "people.inviteSent": "Invitation created",
  "people.inviteLinkNote": "Email isn't set up — share this link with them:",
  "people.copyLink": "Copy",
  "common.done": "Done",
  "bill.title": "Subscription",
  "bill.desc": "Manage your plan and billing.",
  "bill.plan": "Plan",
  "bill.statusActive": "Active",
  "bill.statusTrial": "Trial",
  "bill.statusTrialDays": "Trial · {n} days left",
  "bill.statusPastDue": "Payment past due",
  "bill.statusCanceled": "Canceled",
  "bill.subscribe": "Subscribe",
  "bill.manage": "Manage subscription",
  "bill.notConfigured": "Billing isn't configured yet (set your Stripe keys to enable it).",
  "bill.adminOnly": "Only admins can manage billing.",
  "pay.title": "Your trial has ended",
  "pay.trialEnded": "The free trial for {company} has ended.",
  "pay.subscribeMsg": "Subscribe to keep using your workspace.",
  "pay.adminMsg": "Ask an admin in your company to subscribe to restore access.",
  "pay.subscribe": "Subscribe now",
  "ls.PENDING": "Pending",
  "ls.APPROVED": "Approved",
  "ls.REJECTED": "Rejected",
  "ls.CANCELLED": "Cancelled",
  "lv.balance": "Vacation remaining",
  "lv.ofYear": "of {n}d this year",
  "lv.used": "Used",
  "lv.pending": "Pending",
  "lv.yourReqs": "your requests",
  "lv.outMonth": "Out this month",
  "lv.acrossCompany": "across the company",
  "lv.pendingApprovals": "Pending approvals",
  "lv.nothingAwaiting": "Nothing awaiting your approval.",
  "lv.yourRequests": "Your requests",
  "lv.noRequests": "No requests yet.",
  "lv.companyHolidays": "Company holidays",
  "lv.noHolidays": "No holidays set.",
  "lv.whosAway": "Who's away",
  "lv.nobodyOut": "Nobody's out right now.",
  "lv.approve": "Approve",
  "lv.decline": "Decline",
  "lv.type": "Leave type",
  "lv.startDate": "Start date",
  "lv.endDate": "End date",
  "lv.reasonOpt": "Reason (optional)",
  "lv.reasonPh": "Family trip…",
  "lv.submit": "Submit request",
  "lv.submitting": "Submitting…",
  "fb.nothing": "Nothing here yet.",
  "fb.requestedFrom": "requested feedback from",
  "fb.to": "To",
  "fb.ask": "Ask",
  "fb.feedbackLabel": "Feedback",
  "fb.bodyPh": "Be specific and kind…",
  "fb.askPh": "I'd love your thoughts on…",
  "fb.tags": "Tags",
  "fb.visibility": "Visibility",
  "fb.visPublic": "Public praise — visible to everyone",
  "fb.visManager": "Manager-only — for their manager & admins",
  "fb.visPrivate": "Private — just the two of you",
  "fb.sending": "Sending…",
  "fb.requestTitle": "Request feedback",
  "fb.requestDesc": "Ask a teammate for input.",
  "fb.giveTitle": "Give feedback",
  "fb.whatFor": "What would you like feedback on?",
  "fb.tabAll": "All",
  "fb.tabReceived": "Received",
  "fb.tabGiven": "Given",
  "fb.tabRequests": "Requests",
  "gl2.progress": "Progress",
  "gl2.due": "Due",
  "gl2.unassigned": "Unassigned",
  "gl2.update": "Update",
  "gl2.createTitle": "Create a goal",
  "gl2.titleField": "Title",
  "gl2.description": "Description",
  "gl2.level": "Level",
  "gl2.owner": "Owner",
  "gl2.dueDate": "Due date",
  "gl2.startProgress": "Starting progress",
  "gl2.create": "Create goal",
  "gl2.updateTitle": "Update goal",
  "gl2.addUpdate": "Add an update (optional)",
  "gl2.addUpdatePh": "What changed since last time…",
  "gl2.saveUpdate": "Save update",
  "gl2.noGoalsLevel": "No goals at this level yet.",
  "o2.noOneOnOnes": "No 1:1s yet. Start one with a teammate.",
  "o2.yourReport": "your report",
  "o2.yourManager": "your manager",
  "o2.next": "next",
  "o2.addNotes": "Add notes",
  "o2.noNotes": "No notes yet. Add your first meeting.",
  "o2.agenda": "Agenda",
  "o2.sharedNotes": "Shared notes",
  "o2.privateNotes": "Private notes",
  "o2.onlyYou": "only you",
  "o2.actionItems": "Action items",
  "o2.addAction": "+ Add action",
  "o2.saveNotes": "Save notes",
  "o2.with": "With",
  "o2.cadence": "Cadence",
  "o2.nextMeeting": "Next meeting",
  "o2.create": "Create 1:1",
  "o2.weekly": "Weekly",
  "o2.biweekly": "Every 2 weeks",
  "o2.monthly": "Monthly",
  "o2.addMeetingNotes": "Add meeting notes",
  "o2.agendaPh": "Topics for today…",
  "o2.sharedPh": "Visible to both of you",
  "o2.privatePh": "Just for you",
  "pf.email": "Email",
  ...
  "pf.goals": "Goals",
  "pf.noGoals": "No goals owned.",
  "pf.recentFeedback": "Recent feedback",
  "pf.noFeedback": "No feedback yet.",
  "pf.directReports": "Direct reports",
  "pf.noReports": "No direct reports.",
  "pf.recentLeave": "Recent leave",
  "pf.noLeave": "No leave on record.",
  "pf.adminNotes": "Admin notes",
  "pf.adminNotesVis": "visible to admins & managers only",
  "ad.company": "Company",
  "ad.address": "Address",
  "ad.peopleCol": "People",
  "ad.statusCol": "Status",
  ...
  "ad.activeStat": "Active",
  "ad.peopleAll": "People across all",
  "ad.noEntities": "No entities yet. Create your first one.",
  "ad.createDesc": "Spin up a fresh company workspace at its own address.",
  "ad.wsAddress": "Workspace address",
  "ad.willBeAt": "Will be created at",
  "ad.entitySettings": "Entity settings",
  "ad.changingUrl": "Changing this changes the company's URL.",
  "ad.teams": "Teams",
  "ad.noTeams": "No teams yet.",
  "ad.openWorkspace": "Open workspace",
  "ad.changelogSub": "Updates here appear on the public homepage.",
  "ad.newUpdate": "New update",
  "ad.noUpdates": "No updates yet.",
  "ad.draft": "Draft",
  "ad.postUpdate": "Post an update",
  "ad.editUpdate": "Edit update",
  "ad.category": "Category",
  "ad.summary": "Summary",
  "ad.whatChanged": "What changed (one bullet per line)",
  "ad.published": "Published (visible on homepage)",
  "ad.post": "Post update",
